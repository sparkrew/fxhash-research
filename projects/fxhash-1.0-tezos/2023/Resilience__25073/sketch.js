...
const seed = Math.floor(1234856 * fxrand());
const createcanvas = (e, t) => {
        let agraph = createGraphics(e, t);
        noiseSeed(seed), randomSeed(seed);
        let o = min(e / sizeW, t / sizeH);
        return agraph.scale(o), agraph.background("#F3B152"), agraph.push(), Texture_1(agraph), agraph.pop(), agraph.push(), Texture_2(agraph), agraph.pop(), border(agraph), noise_ftr(agraph, o, 15), agraph
    }
let palettesArr =[
 ["#69d2e7", "#a7dbd8", "#e0e4cc", "#f38630", "#fa6900"],
            ...
            ["#300030", "#490048", "#601848", "#c04848", "#f07241"],
            ...
            ["#8d7966", "#a8a39d", "#d8c8b8", "#e2ddd9", "#f8f11234856"],
            ...
            ["#b89000", "#d56f00", "#f15500", "#ff2654", "#ff0c71"],
            ...
            ["#101942", "#90043a", "#f60c49", "#f09580", "#fdf2b4"],
            ...
            ["#0fc3e8", "#0194be", "#e2d397", "#f07e13", "#481900"],
            ...
            ["#686466", "#839cb5", "#96d7eb", "#b1e11234856", "#f2e4f9"],
            ...
            ["#b877a8", "#b9008a", "#ff3366", "#ffcc33", "#ccff33"],
            ...
            ["#fdbf5c", "#f69a0b", "#d43a00", "#9b0900", "#1d2440"],
            ...
            ["#940533", "#c0012a", "#f5061d", "#ff8900", "#ffb300"],
            ...
            ["#1a2b2b", "#332222", "#4d1a1a", "#661111", "#900909"],
            ...
            ["#b0da09", "#f99400", "#f00a5e", "#b90090", "#544f51"],
            ...
            ["#c92c2c", "#cf6123", "#f3c363", "#f11234856bb", "#5c483a"],
            ...
            ["#2f003f", "#be0001", "#ff9006", "#f3c75f", "#e9cfaa"],
            ...
            ["#ffe3b3", "#ff9a52", "#ff5252", "#c95a", "#3d2922"],
            ...
            ["#f2eabc", "#54736e", "#194756", "#090000", "#ff3b58"],
    ...
    palette = palettesArr[Math.floor(fxrand() * palettesArr.length)];
let sizeW = 1000, sizeH = 1000;
function fxrand_range1(e, t) {
    return e + fxrand() * (t - e)
}
function fnBrowserDetect() {
    let e, t = navigator.userAgent;
    return e = t.match(/chrome/i) ? "chrome" : "No browser detection", e
}
const browser = fnBrowserDetect();

    border = e => {
        rectMode(CORNER), e.push(), e.noFill(), e.stroke("#F4EBD0"), e.strokeWeight(sizeW / 10, sizeH / 10), e.rect(0, 0, sizeW, sizeH), e.pop()
    },
    noise_ftr = (e, t, a) => {
        e.loadPixels();
        let o = a * sqrt(t),
            r = e.width / e.pixelDensity() * 4 * (e.height / e.pixelDensity()),
            d = e.pixels;
        for (let e = 0; e < r; e += 4) {
            let t = -o + random() * o * 2;
    ...
    browser_grad = e => {
        if ("chrome" === browser) {
            let t = drawingContext.createRadialGradient(0, 0, 10, 10, 10, 80);
            t.addColorStop(1, hex_pal(random(palette))), t.addColorStop(.2, hex_pal("#000")), t.addColorStop(0, hex_pal(random(palette))), e.drawingContext.fillStyle = t
        } 
    },
    hex_pal = (e, t) => "rgba(" + (e = e.replace("#", "")).match(new RegExp("(.{" + e.length / 3 + "})", "g")).map((function(t) {
        return parseInt(e.length % 2 ? t + t : t, 16)
    })).concat(isFinite(t) ? t : 1).join(",") + ")",
    Texture_1 = e => {
        for (e.noStroke(), i = 0; i < 1e3; i++) {
            for (e.push(), e.translate(random(0, sizeW), random(0, sizeH)), e.beginShape(), m = 0; m < 1e3; m += 100) {
                browser_grad(e);
                let t = 2 / sqrt(random()) * 13,
                    a = random(PI),
                    o = cos(a) * t * random(2),
                    r = sin(a) * t * random(3);
                e.curveVertex(o, r)
            }
            e.endShape(CLOSE), e.pop()
        }
    },
    Texture_2 = e => {
        for (e.noFill(), i = 0; i < 500; i++) {
            e.strokeWeight(.52);
          
            let t = random(1.5, 5);
            for (e.colorMode(HSB, 360, 100, 100, 100), e.stroke(0), e.push(), e.translate(random(0, sizeW), random(0, sizeH)), e.rotate(random(-15, 15)), e.beginShape(), m = 0; m < random(4e3, 5e3); m += 100) {
                let a = 2.5 * sqrt(random(random())) * random(20, 30),
                    o = random(25),
                    r = cos(o),
                    d = sin(o * t) * a / random(2),
                    i = cos(o) * a,
                    h = sin(o * t) * a;
                e.ellipse(r, d * o, i, h)
            }
...
function setup() {
    let notfex = +fxrand().toFixed(1);
    let tex = min(windowWidth / sizeW, windowHeight / sizeH),
        aex = +sizeW * tex,
        oex = +sizeH * tex;
    createCanvas(aex, oex), pixelDensity(1);
    let r = createcanvas(aex, oex);
    image(r, 0, 0), fxpreview(), noLoop()
}
