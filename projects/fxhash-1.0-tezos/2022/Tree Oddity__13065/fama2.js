...
function Fama2(){
  ...
  if(rt==0){rtt=120; rha= 220; rha1= 66; rhap= 270; rhap1= 81;}
  if(rt==1){rtt=70; rha= 66; rha1= 220; rhap= 81; rhap1= 270;}
  ...
  for(let theta = 0; theta < v.length; theta++){
    ...
    if(rd==0){fill(45, 60-theta, 60);} // amarela
    if(rd==1){fill(400, 30-theta, 60);} // verde
    if(rd==2){fill(20, 65-theta, 60);} // laranja
    if(rd==3){fill(270, 65-theta, 60);} // lilas
    if(rd==4){fill(400, 65-theta, 60);} // vermelha
    if(rd==5){fill(300, 65-theta, 60);} // rosa escuro
    if(rd==6){fill(220, 65-theta, 60);} // azul
