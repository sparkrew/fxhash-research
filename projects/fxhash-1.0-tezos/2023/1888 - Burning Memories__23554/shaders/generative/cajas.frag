...
float de(vec3 p) 
{
    ...
    float ms = floor(mapr(mss,2.0,10.0))+1.;
	
	
	
	mat2 rotxz = rotate2d(mouse.x*pi*2.+mrotx*pi);
    mat2 rotyz = rotate2d(mouse.y*pi*2.+mroty*pi);
    ...
    */
    ...
    float obj1 = obj1(p2,vec3(mapr(cajasizx,0.0,10.0),mapr(cajasizy,0.0,10.0),0.2));
