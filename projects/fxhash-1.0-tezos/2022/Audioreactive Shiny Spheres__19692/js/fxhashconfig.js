...
function setFxhash_tommy(){

	uniforms_fxhash.effect_mix = 0.75;
	uniforms_fxhash.effect_exp = 0.25;
	uniforms_fxhash.color_mix = 1.00;
	uniforms_fxhash.sample_size = 0.8;
	uniforms_fxhash.brightness = 0.8;


	uniforms_fxhash.min1 = genR(.2,.38);
	
	uniforms_fxhash.max1 = 1.0;
