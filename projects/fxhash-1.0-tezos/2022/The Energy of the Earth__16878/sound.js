...
function setup() {
  ...
  _ampR = random(255, 3020);
  _ampG = random(255, 3020);
  _ampB = random(255, 3020);
  for (let i = 0; i < 3; i++) {
    _aryInitNoiseXYZ[i] = random(100);
    _aryInitRot[i] = random(360);
  }
  _aryNoiseRangeXYZ[0] = 0.73/1.5/4;
  _aryNoiseRangeXYZ[1] = 0.73/1.5/4;
  _aryNoiseRangeXYZ[2] = 0.73/1.5/4;
  _noiseStepT = 0.004;
...
function draw() {
  background(200);
  scale(.8);
  directionalLight(25, 35, 105, -1, 1, -1);
  ambientLight(80);
  push();
  ...
  for (let i = 0; i < _aryTriangle.length; i++) {
    ...
    specularMaterial(noiseVal*300, 255, 255);
...
function mouseReleased() {
  ...
  _aryNoiseRangeXYZ[0] = 1.0/2.5/4;
  _aryNoiseRangeXYZ[1] = 1.0/2.5/4;
  _aryNoiseRangeXYZ[2] = 1.0/2.5/4;
  _noiseStepT = 0.004;
