...
let characterClass
let characterClasses = ['Netrunner', 'Samurai', 'Street kid']
...
let grassColor = '#80564c'
let thickGrassColor = '#768c94'
let thickerGrassColor = '#3b4b40'
let waterColor = '#bbe95a'
let debrisColor = '#708587'
let overlayColor = '#4b6872'
