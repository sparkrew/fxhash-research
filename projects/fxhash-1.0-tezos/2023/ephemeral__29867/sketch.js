...
// 再帰的に分割する
async function divideRect(x, y, w, h, minW, minH, count) {
  ...
  if (
    ...
    if (w > h) {
      await divideRect(x, y, w * divideRate, h, minW, minH, count + 1);
      await divideRect(
        x + w * divideRate,
        y,
        w * (1 - divideRate),
      ...
      await divideRect(x, y, w, h * divideRate, minW, minH, count + 1);
      await divideRect(
        x,
        y + h * divideRate,
        w,
