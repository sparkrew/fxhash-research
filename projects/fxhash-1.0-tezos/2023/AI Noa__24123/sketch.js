...
window.addEventListener("load",(()=>{let e=[],r=0,t=[];for(let e=0;e<51;e++)t[e]="./images/"+e+".png";
document.getElementById("AItezoart").getContext("2d");
var a=new layeredCanvas("AItezoart");
for(let n=0;n<=2;n++){let o=Math.floor(50*fxrand());
  a.addLayer({id:r++,render:function(r,a){e[o]=new Image,e[o].src=t[o],e[o].onload=function(){
  if(n % 2 == 0) {
      a.save();
      a.scale(-1, 1);
    a.drawImage(e[o],(300*n*-1)-300,0);
    a.restore();
}
else {
    a.drawImage(e[o],300*n,0);}
  }}})}a.render(),fxpreview()}));
