...
class colorsManage {
    ...
    static getLightestColor(colors) {
        ...
        for (let i = 1; i < colors.length; i++) {
            ...
            if (this.getBrightness(currentColor) > this.getBrightness(lightestColor)) {
...
function paperTexture(instance) {
    ...
    for (i = 0; i < textureNum; i++) {
        stroke(instance.randomInt(100, 150), instance.randomInt(100, 150), instance.randomInt(100, 150), 24);//12
