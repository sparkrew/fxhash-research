...
/*  colorsArray.push(color("#ccd5ae"));
    colorsArray.push(color("#e9edc9"));
    colorsArray.push(color("#fefae0"));
    colorsArray.push(color("#faedcd"));
    colorsArray.push(color("#d4a373"));
    colorArrays.push(colorsArray);
    colorsArray = [];
 */ 
    
/*  colorsArray.push(color("#edede9"));
    colorsArray.push(color("#d6ccc2"));
    colorsArray.push(color("#f5ebe0"));
    colorsArray.push(color("#e3d5ca"));
    colorsArray.push(color("#d5bdaf"));
    colorArrays.push(colorsArray);
    colorsArray = [];
*/    
    
    
/*  colorsArray.push(color("#dad7cd"));
    colorsArray.push(color("#a3b18a"));
    colorsArray.push(color("#588157"));
    colorsArray.push(color("#3a5a40"));
    colorsArray.push(color("#344e41"));
    colorArrays.push(colorsArray);
    colorsArray = [];
*/  
    //17
...
*/  
    //23
/*    colorsArray.push(color("#f8f9fa"));
    colorsArray.push(color("#e9ecef"));
    colorsArray.push(color("#dee2e6"));
    colorsArray.push(color("#ced4da"));
    colorsArray.push(color("#adb5bd"));
    colorsArray.push(color("#6c757d"));
    colorsArray.push(color("#495057"));
    colorsArray.push(color("#343a40"));
    colorsArray.push(color("#212529"));
    colorArrays.push(colorsArray);
    colorsArray = [];
*/  
...
/////////////////////////////////////////////////////////////  4 Colors ////////////////////////////////////////
    colorsArray.push(color('#222831'));
    colorsArray.push(color('#393E46'));
    colorsArray.push(color('#00ADB5'));
    colorsArray.push(color('#EEEEEE'));
    colorArrays.push(colorsArray);
    colorsArray = [];
...
/////////////////////////////////////////////////////////////  5 Colors ////////////////////////////////////////
    ...
    */
    ...
    colorsArray = [];
/*
    colorsArray.push(color("#cad2c5"));
    colorsArray.push(color("#84a98c"));
    colorsArray.push(color("#52796f"));
    colorsArray.push(color("#354f52"));
    colorsArray.push(color("#2f3e46"));
    colorArrays.push(colorsArray);
    colorsArray = [];
*/
    ...
    colorsArray = [];
    //20
/*    colorsArray.push(color("#22223b"));
    colorsArray.push(color("#4a4e69"));
    colorsArray.push(color("#9a8c98"));
    colorsArray.push(color("#c9ada7"));
    colorsArray.push(color("#f2e9e4"));
    colorArrays.push(colorsArray);
    colorsArray = [];
*/    //21
...
*/    
    ...
    colorsArray.push(color("#606c38"));
    colorsArray.push(color("#283618"));
    colorsArray.push(color("#fefae0"));
    colorsArray.push(color("#dda15e"));
    colorsArray.push(color("#bc6c25"));
    colorArrays.push(colorsArray);
    colorsArray = [];
...
*/    //28
    ...
    colorsArray = [];
    //29
/*    colorsArray.push(color("#f0ead2"));
    colorsArray.push(color("#dde5b6"));
    colorsArray.push(color("#adc178"));
    colorsArray.push(color("#a98467"));
    colorsArray.push(color("#6c584c"));
    colorArrays.push(colorsArray);
    colorsArray = [];
*/    //3
...
/*    
    colorsArray.push(color("#ffcdb2"));
    colorsArray.push(color("#ffb4a2"));
    colorsArray.push(color("#e5989b"));
    colorsArray.push(color("#b5838d"));
    colorsArray.push(color("#6d6875"));
    colorArrays.push(colorsArray);
    colorsArray = [];
*/    
...
/*    
    colorsArray.push(color("#8e9aaf"));
    colorsArray.push(color("#cbc0d3"));
    colorsArray.push(color("#efd3d7"));
    colorsArray.push(color("#feeafa"));
    colorsArray.push(color("#dee2ff"));
    colorArrays.push(colorsArray);
    colorsArray = [];
*/    //38
/*    colorsArray.push(color("#d8e2dc"));
    colorsArray.push(color("#ffe5d9"));
    colorsArray.push(color("#ffcad4"));
    colorsArray.push(color("#f4acb7"));
    colorsArray.push(color("#9d8189"));
    colorArrays.push(colorsArray);
    colorsArray = [];
*/    //39
/*    colorsArray.push(color("#463f3a"));
    colorsArray.push(color("#8a817c"));
    colorsArray.push(color("#bcb8b1"));
    colorsArray.push(color("#f4f3ee"));
    colorsArray.push(color("#e0afa0"));
    colorArrays.push(colorsArray);
    colorsArray = [];
*/    //40
...
function drawColors(){
    ...
    for(let a = 0; a < colorArrays.length; a++){
        for(let b = 0; b < colorArrays[a].length; b++){
            ...
            //print("green",greens);
            //print("blue",blues);
            if(reds > 220 && greens > 220 && blues > 220){
                whiteList.push(a);
            }
            if(reds < 35 && greens < 35 && blues < 35){
                blackList.push(a);
            }
