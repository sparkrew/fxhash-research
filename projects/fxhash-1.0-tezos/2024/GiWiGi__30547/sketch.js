...
var nnn=14;
var mmm=Math.floor(2400*$fx.rand());
var flip=0;
var repeat=3;
...
if(n>0){
	context.globalCompositeOperation =  mode[5];
    	a.drawImage(e[o],Math.floor($fx.rand()*1200)+1200,Math.floor($fx.rand()*1200)+1200);
}
else 
{
	context.globalCompositeOperation =  mode[5];
...
drawRotatedSquare(Math.floor($fx.rand()*2400), Math.floor($fx.rand()*2400), color [Math.floor($fx.rand()*5)],  Math.floor($fx.rand()*1500)+300, 50, context , Math.floor(55*$fx.rand())+10,color[Math.floor(5*$fx.rand())]);

	if(Math.floor(5*$fx.rand())>1){
	context.globalCompositeOperation =  mode[Math.floor(5*$fx.rand())];
  	cl(Math.floor($fx.rand()*1200), Math.floor($fx.rand()*1200), color [Math.floor($fx.rand()*5)],  Math.floor($fx.rand()*50)+50, context , Math.floor(55*$fx.rand())+10,color[Math.floor(5*$fx.rand())]);
}
	if(Math.floor(5*$fx.rand())>1){
	context.globalCompositeOperation =  mode[Math.floor(5*$fx.rand())];
  	cl(Math.floor($fx.rand()*1200), Math.floor($fx.rand()*1200), color [Math.floor($fx.rand()*5)],  Math.floor($fx.rand()*150)+150, context , Math.floor(55*$fx.rand())+10,color[Math.floor(5*$fx.rand())]);
}
	if(Math.floor(5*$fx.rand())>1){
	context.globalCompositeOperation =  mode[Math.floor(5*$fx.rand())];
  	cl(Math.floor($fx.rand()*1200), Math.floor($fx.rand()*1200), color [Math.floor($fx.rand()*5)],  Math.floor($fx.rand()*250)+250, context , Math.floor(55*$fx.rand())+10,color[Math.floor(5*$fx.rand())]);
}
	if(Math.floor(5*$fx.rand())>1){
	context.globalCompositeOperation =  mode[Math.floor(5*$fx.rand())];
  	cl(Math.floor($fx.rand()*1200), Math.floor($fx.rand()*1200), color [Math.floor($fx.rand()*5)],  Math.floor($fx.rand()*450)+450, context , Math.floor(55*$fx.rand())+10,color[Math.floor(5*$fx.rand())]);
}
	if(Math.floor(5*$fx.rand())>1){
	context.globalCompositeOperation =  mode[Math.floor(5*$fx.rand())];
  	cl(Math.floor($fx.rand()*1200), Math.floor($fx.rand()*1200) , color [Math.floor($fx.rand()*5)],  Math.floor($fx.rand()*400)+800, context , Math.floor(55*$fx.rand())+10,color[Math.floor(5*$fx.rand())]);
}
