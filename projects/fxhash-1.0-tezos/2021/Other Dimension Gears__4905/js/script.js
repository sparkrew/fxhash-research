...
uniforms_fxhash.height = 0.51;
uniforms_fxhash.light_dir_x = 0.0;
uniforms_fxhash.light_dir_y = 0.61;
uniforms_fxhash.light_dir_z = 0.33;
uniforms_fxhash.ambient = 0.3;
uniforms_fxhash.diffuse = 0.49;
uniforms_fxhash.specular_red = 0.;
uniforms_fxhash.specular_green = 0.;
uniforms_fxhash.specular_blue = 0.;
uniforms_fxhash.specular_blue = 0.86;
uniforms_fxhash.specular_size = 0.9;


uniforms_fxhash.freq = fxrand();
uniforms_fxhash.siz_x = fxrand();
uniforms_fxhash.siz_z = fxrand();
uniforms_fxhash.rotz = fxrand();
uniforms_fxhash.speedz = fxrand();
uniforms_fxhash.msm = fxrand();


uniforms_fxhash.size = 1.00;
uniforms_fxhash.difuse2 = 0.05;

window.$fxhashFeatures = {
	"Frequency": uniforms_fxhash.freq.toFixed(2),
	"Size in X": uniforms_fxhash.siz_x.toFixed(2),
	"Size in Z ": uniforms_fxhash.siz_z.toFixed(2),
	"Rotation Index": uniforms_fxhash.rotz.toFixed(2),
	"Speed Z ": uniforms_fxhash.speedz.toFixed(2),
	"Space Fracting": uniforms_fxhash.msm.toFixed(2)
} 
...
function preload() {
	...
	RM.addShader('shaders/generative/torsionengine.frag', 0, "torsionengine.frag");
