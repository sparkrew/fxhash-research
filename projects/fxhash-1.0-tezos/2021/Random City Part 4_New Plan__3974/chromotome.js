(function (global, factory) {
  ...
  var misc = [
    ...
    {
      name: 'sprague',
      colors: ['#ec2f28', '#f8cd28', '#1e95bb', '#fbaab3'],
      stroke: '#221e1f',
      background: '#fcefdf',
    },
    {
  ...
  var tsuchimochi = [
    {
      name: 'tsu_arcade',
      colors: ['#4aad8b', '#e15147', '#f3b551', '#d1af84', '#544e47'],
      stroke: '#251c12',
      background: '#cfc7b9'
    },
    {
  ...
  var flourish = [
    ...
    {
      name: 'delphi',
      colors: ['#475b62', '#7a999c', '#2a1f1d', '#fbaf3c', '#df4a33', '#af592c'],
      stroke: '#2a1f1d',
      background: '#f0e0c6',
    },
    {
    ...
    {
      name: 'skyspider',
      colors: ['#f4b232', '#01799c', '#e93e48', '#0b1952', '#006748', '#ed817d'],
      stroke: '#050505',
      background: '#f0dbbc',
    },
    {
  ...
  function getRandomF(float) {
    return palettes[Math.floor(float * palettes.length)];
  }
