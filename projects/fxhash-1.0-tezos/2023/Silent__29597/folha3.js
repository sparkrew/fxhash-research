...
function folha3(s, len, cor1, cor2, sat, b1, b2){
  ...
  rotate(-PI/6) // movimento das folhas
  //rotateX(PI/random( 10))
//  rotateY(PI/random(-10, 10))
//  line(0, 0, 0, -len/10)
  translate(-width/35, len/3)
  rotateX(PI/2.5)
//  rotateZ(PI/16)

//  var rd = int(random(2))
//  if(rd == 0){
    noStroke(); fill(random(cor1, cor2), sat, random(b1,b2)) // fill(random(20, 100), 150, random(5,8))
    //}
//  if(rd == 1){noFill()}
  beginShape();
...
//  fill(random(80, 50), random(80, 50), random(10, 30))
  ...
  endShape();random(cor1, cor2), sat, random(b1,b2)
  pop()
  ...
  strokeWeight(1)
 // stroke(random(cor1, cor2), sat, random(b1,b2))
  rotate(-PI/1.3) // movimento das folhas
  //rotateX(PI/random( 10))
//  rotateY(PI/random(-10, 10))
  //line(0, 0, 0, -len/10)
  translate(-width/20, -len/5)
  rotateX(PI/1.7)
//  rotateZ(PI/16)
