...
var repeat=Math.floor(3*fxrand());
  var color=["rgb(255, 0, 0,1)","rgb(255, 50, 0,1)","rgb(255, 150, 50,0.3)","rgb(255, 255, 100,0.3)","rgb(255, 100, 0,0.3)"]
...
a.drawImage(e[o],mmm*n,0);
	...
	context.globalCompositeOperation = mode[0];
    	...
    	drawTriangle(context, 0, 0, Math.floor(Math.floor(2400*fxrand())), 0, 0, Math.floor(Math.floor(2400*fxrand())), triangleColor, 0);
	}
	...
	context.globalCompositeOperation =  mode[0];
    	triangleColor = color[Math.floor(Math.floor(5*fxrand()))];
    	drawTriangle(context, Math.floor(Math.floor(2400*fxrand())), 0, 0,Math.floor(Math.floor(2400*fxrand())), 2400, 2400, triangleColor, 0);
}
for(let m=0;m<=20;m++){
	if(Math.floor(5*fxrand())<1){
	context.globalCompositeOperation =  mode[0];
  	cl(Math.floor(fxrand()*2400), Math.floor(fxrand()*2400), color [Math.floor(fxrand()*5)],  Math.floor(fxrand()*50)+50, context , Math.floor(55*fxrand())+10,color[Math.floor(5*fxrand())]);
}
}
