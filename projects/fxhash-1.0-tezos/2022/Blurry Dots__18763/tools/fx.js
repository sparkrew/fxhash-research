...
function dropShad(offX, offY, blur, clr, alpha) {
    g1.drawingContext.shadowOffsetX = offX;
    g1.drawingContext.shadowOffsetY = offY;
    g1.drawingContext.shadowBlur = blur;
    g1.drawingContext.shadowColor = color(clr, alpha);
}

function dropShad2(offX, offY, blur, clr, alpha) {
