...
let colorMain, colorMain2, palette;
  ...
  function setup() {
    ...
    scc = 1;
  	...
  	minSizeChoice = 1;
  	maxSizeChoice = int(random(1,3));//min(3,max(windowSizeChoice,minSizeChoice));

  	sizeChoice = int(random(5,maxSizeChoice+0.1));
  	}else{
  	...
  	goSmallerSizeChoice = int(random(0,1.1));
  	...
  	addx = random(bufferx,centerx/1.1);
  	addy = random(buffery,centery/1.1);
  	//print(addx);
  	//print(addy);
