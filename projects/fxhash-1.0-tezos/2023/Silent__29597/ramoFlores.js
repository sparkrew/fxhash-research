...
function ramoFlores(len, cor1, cor2, sat, b1, b2, ef){
  scale(1.1)
//  rotateX(0.1)
  push()
...
//  line(0, 0, 0, -len)
  ...
  folhaC(s, width/3, cor1, cor2, sat, b1, b2)
  //folha(s, width/3, 70, random(30, 90), 8, random(4, 10))
  //folha(s, width/3)
   var rdf = int(random(15))
   if(rdf==0){
     var ss = width/21000; // escala das folhas
  ...
  if(len > width/100){
    ...
    ramoFlores(len * 0.85, cor1, cor2, sat, b1, b2, ef);
