...
class AlienManager {
    constructor() {
        ...
        this.marcos = new imgManager(0, 0, "img/alienenciclopedia/marcos/marco", uniforms_fxhash.marco);
       // this.marcos2 = new imgManager(0, 0, "img/alienenciclopedia/marco", 7);
        ...
        this.RM3.addShader('shaders/imageprocessing/chromaalien.frag', 0, "invert.frag");
        //this.orden = shuffle([0, 1, 2, 3]);
        this.orden = [0, 1, 2, 3];


        let idxorden = floor(genR(11));
        if (idxorden == 0) {
            this.orden = [1, 0, 2, 3];
        } else if (idxorden == 1) {
            this.orden = [1, 2, 0, 3];
      ...
      //  this.idxplanta = 0.6;
        ...
        this.sm = 0.0;      //Size multiplyer; 
        for (let k = 1; k < 95; k++) {
            let indx = k;
            if (k < 10) {
                indx = "0" + k.toString();
            }
            if (uniforms_fxhash.planta1 == 1) {
                this.flor3.push(loadImage("img/alienenciclopedia/seqplanta1/planta1_0" + indx + ".jpg"));
            } else if (uniforms_fxhash.planta1 == 2) {
                this.flor3.push(loadImage("img/alienenciclopedia/seqplanta2/planta2_00" + indx + ".jpg"));
            } else if (uniforms_fxhash.planta1 == 3) {
                if (k < 10) {
                    indx = "0" + k.toString();
                }
                this.flor3.push(loadImage("img/alienenciclopedia/seqplanta3/Planta3_00" + indx + ".jpg"));
            } else if (uniforms_fxhash.planta1 == 4){
                this.flor3.push(loadImage("img/alienenciclopedia/seqplanta4/planta4_00" + indx + ".jpg"))
            }
        }


        let idxplanta2 = uniforms_fxhash.planta1;
        this.plantasec = [];
        for (let k = 1; k < 95; k++) {
            let indx = k;
            if (k < 10) {
    ...
    setup() {
        ...
        this.positions = [createVector(width / 2 - sepx2, height / 2 - sepx2),
                          createVector(width / 2 + sepx2, height / 2 + sepx2*.9),
    ...
    setChromaUniforms() {
        ...
        if (uniforms_fxhash.planta1 == 1) {
            ...
            this.RM2.objts[0].localUniformsValues[3] = 0.72;
            this.sm = 0.5;
        } else if (uniforms_fxhash.planta1 == 2) {
            ...
            this.RM2.objts[0].localUniformsValues[1] = 1.0;
            this.RM2.objts[0].localUniformsValues[2] = 0.0;
            this.RM2.objts[0].localUniformsValues[3] = 0.77;
            this.sm = 1.5;
        } else if (uniforms_fxhash.planta1 == 3) {
          
            this.RM2.objts[0].localUniformsValues[0] = 1.0;
            this.RM2.objts[0].localUniformsValues[1] = 0.0;
            this.RM2.objts[0].localUniformsValues[2] = 0.0;
            this.RM2.objts[0].localUniformsValues[3] = 0.81;
            this.sm = 1.5;
            ...
            this.RM2.objts[0].localUniformsValues[1] = 1.0;
            this.RM2.objts[0].localUniformsValues[2] = 0.0;
            this.RM2.objts[0].localUniformsValues[3] = 0.7;
            this.sm = 1.5;
        }
    ...
    drawPlantaSec(_x, _y) {
        ...
        this.RM2.draw(x, y,
            this.plantasec[this.idx2].width * 0.5,
            this.plantasec[this.idx2].height * 0.5);
        imageMode(CORNER);
    }
    drawModel(_x, _y) {
        let x = _x;
        ...
        this.RM2.draw(x, y, this.flor3[this.idx2].width * this.sm, this.flor3[this.idx2].height * this.sm);
        imageMode(CORNER);
