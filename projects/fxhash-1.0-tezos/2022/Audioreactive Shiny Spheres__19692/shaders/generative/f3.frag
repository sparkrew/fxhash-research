...
void main(void){   
    ...
    vec2 uv = gl_FragCoord.xy/resolution.xy;
         uv = vTexCoord;
    float e2 = fbm(uv*10000.2+fbm(uv*8.,100.),9239898.);
          float e = noise(uv*2000.,6265.);
        //  e = rxr(uv*0.2);
    ...
    vec3 fin2 = mix(vec3(r1,g1,b1),vec3(r2,b2,g2),f2*e);
    gl_FragColor = vec4(fin2,vig*.04*e2+e*.15);
}