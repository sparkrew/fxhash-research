...
class Director {
    ...
    _setup() {
        ...
        this.fullHDCanvasSettings = {
            count: fxrand() * 600,
            particleSizeY: fxrand() * 39,
            particleSizeX: 0.48,
            fatLineQuantity: 9,
            fatLineWidth: 15,
            fatLineHeight: fxrand() * 250,
            floatAmplitude: 10,
        };
...
class Particle {
    constructor(settings) {
        this.scale = settings.scale[Math.floor(fxrand() * settings.scale.length)];
        ...
        this.dy = 0;
        this.floatAmplitude = fxrand() * (settings.floatAmplitude || 0);
        this.settings = settings;
        this.changePosition();
    ...
    getRandomXCoords() {
        return Math.floor(fxrand() * (this.settings.canvasWidth - this.settings.particleSizeX * 2));
    }

    getRandomYCoords() {
        return Math.floor((this.settings.canvasHeight / 2) - (this.height * fxrand()));
    }
...
class RectParticle1 extends Particle {
    ...
    prepareDraw(ctx) {
        ...
        this.line1Grd1.addColorStop(0.04, `rgba(${fxrand() * 255},${fxrand() * 255},${fxrand() * 255})`);
        this.line1Grd1.addColorStop(0.18, `rgba(${fxrand() * 255},${fxrand() * 255},${fxrand() * 255})`);
        this.line1Grd1.addColorStop(0.82, `rgba(${fxrand() * 255},${fxrand() * 255},${fxrand() * 255})`);
        this.line1Grd1.addColorStop(0.97, `rgba(${fxrand() * 255},${fxrand() * 255},${fxrand() * 255})`);

        this.line1Grd2 = ctx.createLinearGradient(0, 0, 0, this.height);
        this.line1Grd2.addColorStop(0, `rgba(${fxrand() * 255},${fxrand() * 255},${fxrand() * 255})`);
        this.line1Grd2.addColorStop(0.02, `rgba(${fxrand() * 255},${fxrand() * 255},${fxrand() * 255})`);
        this.line1Grd2.addColorStop(0.09, `rgba(${fxrand() * 255},${fxrand() * 255},${fxrand() * 255})`);
        this.line1Grd2.addColorStop(0.17, `rgba(${fxrand() * 255},${fxrand() * 255},${fxrand() * 255})`);
        this.line1Grd2.addColorStop(0.28, `rgba(${fxrand() * 255},${fxrand() * 255},${fxrand() * 255})`);
        this.line1Grd2.addColorStop(0.49, `rgba(${fxrand() * 255},${fxrand() * 255},${fxrand() * 255})`);
        this.line1Grd2.addColorStop(0.72, `rgba(${fxrand() * 255},${fxrand() * 255},${fxrand() * 255})`);
        this.line1Grd2.addColorStop(0.88, `rgba(${fxrand() * 255},${fxrand() * 255},${fxrand() * 255})`);
        this.line1Grd2.addColorStop(0.98, `rgba(${fxrand() * 255},${fxrand() * 255},${fxrand() * 255})`);
        this.line1Grd2.addColorStop(1, `rgba(${fxrand() * 255},${fxrand() * 255},${fxrand() * 255})`);
...
class RectParticle2 extends Particle {
    ...
    prepareDraw(ctx) {
        ...
        this.line2Grd1.addColorStop(0, `rgba(${fxrand() * 255},${fxrand() * 255},${fxrand() * 255})`);
        this.line2Grd1.addColorStop(1, `rgba(${fxrand() * 255},${fxrand() * 255},${fxrand() * 255})`);
        super.prepareDraw(ctx);
    }
